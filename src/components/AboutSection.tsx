...
const AboutSection: React.FC = () => {
  ...
  <GraduationCap className="w-32 h-32 text-yellow-500" />
</div>
          <div className="md:w-1/2 md:pl-12">
            <h3 className="text-2xl font-bold mb-4">Интерактивное обучение нефтегазовой отрасли</h3>
            <p className="text-gray-700 mb-4">
              Цифровая Образовательная Платформа "Югра.Нефть создана для школьников, интересующихся нефтегазовой отраслью. 
