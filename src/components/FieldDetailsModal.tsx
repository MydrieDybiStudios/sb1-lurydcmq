...
import { X, Calendar, Factory, Gauge, CircleDot, Droplet, Zap, Shield, Wind, MapPin } from 'lucide-react';
      ...
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-gradient-to-b from-gray-900 to-black rounded-2xl border-2 border-yellow-500/30 shadow-2xl">
        ...
        <div className="p-8">
          ...
          <div className="space-y-6">
            ...
            {/* История */}
            <div className="bg-gray-800/30 p-6 rounded-xl border border-gray-700">
              <h3 className="text-xl font-bold text-yellow-400 mb-4">📜 История открытия и разработки</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-800/30 p-6 rounded-xl border border-gray-700">
                <h3 className="text-xl font-bold text-yellow-400 mb-4">🏗️ Инфраструктура</h3>
            ...
            <div className="flex justify-center mt-8">
              <button
                onClick={() => {
                  window.open(field.simulatorLink, '_blank');
                }}
