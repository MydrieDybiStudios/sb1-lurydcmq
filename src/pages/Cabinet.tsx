...
// ========== Вынесенные компоненты для навигации ==========
...
const NavButton: React.FC<NavButtonProps> = ({ onClick, active, icon, label, hideLabel = false }) => (
  <button
    onClick={onClick}
    className={`
      relative px-3 py-2 rounded-xl font-medium transition-all duration-200 flex items-center gap-1.5
      ${active
    ...
    <div className="absolute top-full left-0 right-0 bg-black border-t border-gray-800 px-4 py-3 shadow-2xl animate-slideDown z-50">
      <nav className="flex flex-col space-y-2">
        <button
          ...
          className={`px-4 py-3 rounded-xl font-medium text-left transition flex items-center ${
        ...
        <button
          ...
          className="px-4 py-3 rounded-xl font-medium text-left transition flex items-center text-yellow-400 hover:bg-yellow-500 hover:text-black"
        >
        ...
        <div className="border-t border-gray-800 pt-2 mt-2">
          ...
          <button
            ...
            className="w-full px-8 py-3 rounded-xl font-medium text-left transition flex items-center text-yellow-400 hover:bg-yellow-500 hover:text-black"
          >
        ...
        <div className="border-t border-gray-800 pt-2 mt-2">
          <button
            ...
            className="w-full px-4 py-3 rounded-xl font-medium text-left transition flex items-center text-yellow-400 hover:bg-yellow-500 hover:text-black"
          >
          ...
          <button
            ...
            className="w-full px-4 py-3 rounded-xl font-medium text-left transition flex items-center text-red-400 hover:bg-red-500 hover:text-white"
          >
        ...
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          ...
          {user && (
            <div className="flex items-center space-x-1 sm:space-x-2">
                ...
                <DropdownMenu
                  trigger={
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-2 rounded-xl text-sm font-medium text-yellow-400 hover:bg-yellow-500 hover:text-black transition"
                    >
                  ...
                  <DropdownMenu
                    trigger={
                      <button
                        ...
                        className="flex items-center gap-1 px-3 py-2 rounded-xl text-sm font-medium text-yellow-400 hover:bg-yellow-500 hover:text-black transition border border-yellow-500/30"
                      >
              ...
              {/* Планшетная навигация (md-xl) – только иконки */}
              <nav className="hidden md:flex xl:hidden items-center space-x-1">
                ...
                <DropdownMenu
                  trigger={
                    <button className="p-2 rounded-xl text-yellow-400 hover:bg-yellow-500 hover:text-black transition" title="Меню">
              ...
              <div className="flex items-center space-x-1 sm:space-x-2">
                ...
                <button
                  ...
                  className="p-2 rounded-xl text-red-400 hover:bg-red-500 hover:text-white transition hidden sm:inline-flex"
                  title="Выйти"
                >
                ...
                <button
                  ...
                  className="hidden xl:inline-flex px-3 py-1.5 border border-yellow-500 hover:bg-yellow-500 hover:text-black text-yellow-500 text-sm font-medium rounded-xl transition"
                >
                  На главную
                </button>
